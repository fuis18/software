...
| **WAF**        | Firewall de aplicaciones web en el borde: filtra el tráfico hacia las apps                 |
...
| **Terminación TLS** | Cifra en el edge y descifra para el backend              |
...
- **Emisión** — certificados de dominio legítimos vía HTTP-01/DNS-01 (o v2), con renovación automática.
